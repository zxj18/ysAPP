...
public class VideoHistoryAdapter extends RecyclerView.Adapter<VideoHistoryAdapter.ViewHolder> {
    ...
    VideoHistoryAdapter(Activity activity, List<VodBean> dataList, OnHistoryItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(activity).load(item.getVod_pic()).into(holder.video_history_card_image);
        holder.video_history_card_text.setText(item.getVod_name());
