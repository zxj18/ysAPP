...
public class LiveTitleAdapter extends RecyclerView.Adapter<LiveTitleAdapter.ViewHolder> {
    ...
    public LiveTitleAdapter(Context context, ArrayList<String> dataList, TYPE type, OnClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tv_live_item_title.setFocusable(true);
