...
public class VideoCollectAdapter extends RecyclerView.Adapter<VideoCollectAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(activity).load(item.getVideo().getVod_pic()).into(holder.video_collect_card_image);
        holder.video_collect_card_text.setText(item.getVideo().getVod_name());
