package com.vodbyte.android.widget.commentview.callback;
 ...
 * 2、初始化过程中，自定义Holder必须继承自com.vodbyte.android.widget.commentview.view.ViewHolder,查看{@link ViewHolder}<p>
 *
 * @author Jidcoo
 */
