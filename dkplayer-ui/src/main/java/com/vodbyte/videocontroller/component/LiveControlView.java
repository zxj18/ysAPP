...
public class LiveControlView extends FrameLayout implements IControlComponent, View.OnClickListener {
    ...
    
    {
        ...
        mChangeSource = findViewById(R.id.tv_change_source);
        mChangeSource.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.tv_change_source) {
     ...
     * @param mListener
     */
    public LiveControlView setListener(OnBtnClickViewListener mListener) {
