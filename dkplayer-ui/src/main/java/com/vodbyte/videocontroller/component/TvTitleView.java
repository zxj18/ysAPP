 ...
 * 播放器顶部标题栏
 */
public class TvTitleView extends FrameLayout implements IControlComponent {
    ...
    public TvTitleView(@NonNull Context context) {
        super(context);
    }

    public TvTitleView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TvTitleView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
