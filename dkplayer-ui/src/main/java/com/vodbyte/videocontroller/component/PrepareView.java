...
public class PrepareView extends FrameLayout implements IControlComponent {
    ...
    private OnBtnClickViewListener mBtnListener;
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mBtnListener != null) {
                    mBtnListener.onClickStartPlay(v);
                }else {
                    mControlWrapper.start();
                }
            }
     ...
     * @param mListener
     */
    public PrepareView setListener(OnBtnClickViewListener mListener) {
        this.mBtnListener = mListener;
        return this;
    }

    public interface OnBtnClickViewListener {
        void onClickStartPlay(View view);
    }
