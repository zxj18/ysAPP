...
public class ShareSetting {
    ...
    private static ShareSetting setting = new ShareSetting();

    private ShareSetting() {
        shareMedias = new LinkedHashSet<>();
    }

    public synchronized static ShareSetting getInstance() {
        return setting;
    }
     ...
     * @return
     */
    public ShareSetting setDefShareImageUrl(String url) {
        mDefShareImageUrl = url;
        return setting;
    }

    public ShareSetting setQQAppId(String QQAppId) {
        mQQAppId = QQAppId;
        return setting;
    }

    public ShareSetting setWechatAppId(String wechatAppId) {
        mWechatAppId = wechatAppId;
        return setting;
    }

    public ShareSetting setWeiboAppId(String weiboAppId) {
        mWeiboAppId = weiboAppId;
        return setting;
    }

    public ShareSetting setAppName(String appName) {
        mAppName = appName;
        return setting;
    }
     ...
     * @return
     */
    public ShareSetting setDefImageUrlId(int defShareImageUrlId) {
        mDefShareImageUrlId = defShareImageUrlId;
        return setting;
    }

    public ShareSetting setSinaRedirectUrl(String redirectUrl) {
        mSinaRedirectUrl = redirectUrl;
        return setting;
    }

    public ShareSetting setScope(String scope) {
        mScope = scope;
        return setting;
    }

    public ShareSetting setShareWayIconMap(LinkedHashMap<SHARE_MEDIA, Integer> shareWayMap) {
    ...
    public ShareSetting addShareMedia(SHARE_MEDIA... shareMedia) {
    ...
    public ShareSetting removeShareMedia(SHARE_MEDIA... shareMedia) {
        for (SHARE_MEDIA item : shareMedia) {
