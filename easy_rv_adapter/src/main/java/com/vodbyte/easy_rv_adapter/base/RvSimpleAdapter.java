...
import com.vodbyte.easy_rv_adapter.cell.EmptyCell;
import com.vodbyte.easy_rv_adapter.cell.ErrorCell;
import com.vodbyte.easy_rv_adapter.cell.HeaderCell;
import com.vodbyte.easy_rv_adapter.cell.LoadMoreCell;
import com.vodbyte.easy_rv_adapter.cell.LoadingCell;

import static com.vodbyte.easy_rv_adapter.config.ItemType.EMPTY_TYPE;
import static com.vodbyte.easy_rv_adapter.config.ItemType.ERROR_TYPE;
import static com.vodbyte.easy_rv_adapter.config.ItemType.HEADER_TYPE;
import static com.vodbyte.easy_rv_adapter.config.ItemType.LOADING_TYPE;
import static com.vodbyte.easy_rv_adapter.config.ItemType.LOAD_MORE_TYPE;

/**
 * 对BaseRvAdapter进行基本的封装，子类可以直接继承此类进行修改
 */
public class RvSimpleAdapter extends BaseRvAdapter<BaseRvCell> {
    ...
    public RvSimpleAdapter(){
        ...
        mHeaderCell = new HeaderCell(null);
    }
    @Override
        ...
        if(manager instanceof GridLayoutManager){
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    //当View为各种状态（empty,error,loading..）时，占满格否则；
                    //为正常View,占1格
    ...
    public void showHeaderView(View view){
        mHeaderCell.setView(view);
        mHeaderCell.setHeight(Utils.dpToPx(view.getContext(),160));
        add(mHeaderCell);
    }
